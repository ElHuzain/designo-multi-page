...
const Location = ({ name, office, contact }: LocationType) => {

    const { screenWidth } = useGetScreenWidth();

    return (
        <article className="last:mb-0 lg:odd:flex-row-reverse mb-10 md:mb-[120px] lg:mb-[30px] flex flex-col lg:flex-row lg:gap-8 overflow-hidden sm:rounded-[15px]">
